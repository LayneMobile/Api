...
public abstract class NotifyingSubscriber<T> extends Subscriber<T> {
    ...
    protected NotifyingSubscriber(Subscriber<?> subscriber, boolean shareSubscriptions) {
    ...
    public static <T> NotifyingSubscriber<T> create(Action1<? super T> onNext, Action0 onUnsubscribe) {
    ...
    public static <T> NotifyingSubscriber<T> create(final Subscriber<? super T> actual, final Action0 onUnsubscribe) {
