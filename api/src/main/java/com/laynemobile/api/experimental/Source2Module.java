...
//public final class Source2Module<T, P extends Params> implements SourceHandlerBuilder<T, P> {
//    private Action2<P, Subscriber<? super T>> source;
//
//    public Source2Module<T, P> source(Action2<P, Subscriber<? super T>> source) {
//        this.source = source;
//        return this;
//    }
//
//    public Source2Module<T, P> source(Func1<P, T> source) {
//        return sourceInternal(this, source);
//    }
//
//    @Override public TypeHandler<Source<T, P>> build() {
//        if (source == null) {
//            throw new IllegalStateException("source must be set");
//        }
//        return TypeHandler.<Source<T, P>>builder()
//                .handle("call", new Handler<>(source))
//                .build();
//    }
//
//    private static <T, P extends Params> Source2Module<T, P> sourceInternal(Source2Module<T, P> module,
