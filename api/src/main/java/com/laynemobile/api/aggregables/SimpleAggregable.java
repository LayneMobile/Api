...
public class SimpleAggregable implements Aggregable {
    ...
    public SimpleAggregable(Object key) {
        this(key, DEFAULT_KEEP_ALIVE_SECONDS);
    }

    public SimpleAggregable(Object key, int keepAliveSeconds) {
        this(key, keepAliveSeconds, DEFAULT_KEEP_ALIVE_ON_ERROR);
    }

    public SimpleAggregable(Object key, int keepAliveSeconds, boolean keepAliveOnError) {
        if (key == null) {
