...
import static com.laynemobile.api.internal.Util.nullSafe;
...
final class ModuleBuilder {
    ...
    ModuleBuilder(ApiBuilder apiBuilder, TypeElement module, Types typeUtils) {
        ...
        SourceHandlerModule annotation = module.getAnnotation(SourceHandlerModule.class);
        if (annotation == null) {
            throw new IllegalStateException(
                    module.getQualifiedName() + " must have " + PACKAGE + ".annotations.SourceModule annotation");
        }
        ...
        ApiLog.d(TAG, "module %s", module.getQualifiedName());
        ...
        for (Element sourceElement : module.getEnclosedElements()) {
            switch (sourceElement.getKind()) {
                case CONSTRUCTOR:
                    ApiLog.d(TAG, "module constructor: %s", sourceElement.getSimpleName());
                    ...
                    break;
                case METHOD:
                    ApiLog.d(TAG, "module method: %s", sourceElement.getSimpleName());
                    ...
                    break;
                case FIELD:
                    ApiLog.d(TAG, "module field: %s", sourceElement.getSimpleName());
                    break;
                default:
                    ApiLog.d(TAG, "module element: %s", sourceElement.getSimpleName());
            }
        }
        if (constructor == null) {
