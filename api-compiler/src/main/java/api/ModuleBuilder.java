...
import api.annotations.SourceHandler;
import api.internal.ApiLog;

import static api.Constants.NonNull;
import static api.internal.Util.nullSafe;
...
final class ModuleBuilder {
    ...
    ModuleBuilder(ApiBuilder apiBuilder, TypeElement module, Types typeUtils) {
        ...
        SourceHandler annotation = module.getAnnotation(SourceHandler.class);
        if (annotation == null) {
